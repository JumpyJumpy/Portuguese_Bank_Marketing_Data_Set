...
2. Provide modeling results using multiple machine learning algorithms  
    a.	Include your comments regarding the pros and cons of each algorithm  
    b.	Tells us which algorithm will be your choice for implementation and why  
4. Provide some use cases to show the value to business problem  
