...
# Logistic regression
logit = LogisticRegressionCV(penalty = "l1", solver = "saga", class_weight = {1: weight, 0: 1}).fit(bank_X, bank_y)  # L1 norm to get sparse solution
logit.score(bank_raw_X, bank_raw_y)
logit_coef = bank_raw_X.columns[logit.coef_[0] != 0]

selector = RFECV(LogisticRegression(class_weight = {1: weight, 0: 1}, solver = "liblinear"))
